...
void PrintVisitor::Visit(VarAssignment *statement)
{
    ...
    stream << "var assignment: "
           << std::get<std::string>(statement->var_name->eval()) << std::endl;
    PrintTabs();
...
{
    PrintTabs();
    stream << "local var declaration: '" << statement->var_name << "' of type '"
           << statement->type.ToString() << "'" << std::endl;
}
...
{
    stream << "field declaration: '" << statement->var_name << "' of type '"
           << statement->type.ToString() << "'" << std::endl;
}
