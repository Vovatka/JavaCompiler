#ifndef JAVACOMPILER_EXPRESSION_H
#define JAVACOMPILER_EXPRESSION_H
...
class Expression : public BaseElement
{
  public:
    ...
    void SetScope(ScopeLayer *scope) { scope_ = scope; }

    ScopeLayer *GetScope() const { return scope_; }
...
#endif // JAVACOMPILER_EXPRESSION_H
